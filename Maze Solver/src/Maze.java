...
public class Maze extends JFrame {
	 ...
	 * @throws IOException
	 */
	public Maze(String inFile) throws UnknownMazeCharacterException,
		...
		for (int r = 1; r < row + 1; r++) {
			...
			for (int c = 1; c < col + 1; c++) {
				...
				case 'E':
					...
					break;
				case 'U':
					hexMazeBuilder[r][c] = new Hexagon(
							Hexagon.HexType.UNVISITED);
					break;
				default:
	...
	/**
	 * Get the current time delayed used when repainting the Maze to reflect
	...
	/**
	 * Set the amount of time to wait when repainting the Maze to reflect
	 * changes made to the hexagon tiles
	 * 
	 * @param timeDelay
