...
public class Hexagon extends HexComponent {
	...
	public static enum HexType {
		WALL, START, END, UNVISITED, PROCESSED, PUSHED, END_PROCESSED
	};
	 ...
	 */
	public void setNeighbour(Hexagon neighbor, int i)
	 ...
	 *            on
	 * @return The hexagon the is on the i-th side of the current hexagon, or
	 *         null if no neighbor
	 * @throws InvalidNeighbourIndexException
	 *             When an index is specified that is not 0-5 inclusive.
	 */
	...
	public boolean isUnvisited() {
		return type == HexType.UNVISITED
				|| (this.isEnd() && type == HexType.END);
	}
	...
	/**
	 * This method sets the tile to be a Pushed tile and updates the tile's
	 * colour
	 */
	...
	/**
	 * This method set the tile to be a Visited tile and updates the tile's
	 * colour
	 */
